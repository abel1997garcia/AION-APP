...
import { Play, RefreshCw, Upload, Share2, Monitor, Smartphone, Tablet } from 'lucide-react'
  ...
  return (
    <>
      <div className="h-11 flex items-center gap-2 px-3 border-b border-aion-border bg-aion-panel shrink-0">
        ...
        {/* Export button — Web / PWA / App Store */}
        <button
          onClick={() => setShowExport(true)}
          title="Exportar — Web, PWA, App Store & Google Play"
          className="flex items-center gap-1.5 border border-aion-border hover:border-aion-accent/60 bg-aion-surface hover:bg-aion-accent/10 text-aion-muted hover:text-aion-accent-light text-sm font-medium px-3 py-1.5 rounded-lg transition-all"
        >
          <Upload size={13} />
